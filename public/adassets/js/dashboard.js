  ...
  $(function() {
    ...
    var webAudienceMetricsSatackedData = {
      ...
      datasets: [
        {
          label: 'Sessions',
          data: [24000,83123,24000,36000,20000,39000,72000,44000,18000,200000,12000],
          backgroundColor: [
            '#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc',
          ],
          borderColor: [
            '#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc','#3794fc',
          ],
