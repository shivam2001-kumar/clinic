        ...
        <section>
            <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('/stockmanager/save_bulk_data')}}" class="needs-validation" id="" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                
                            <div class="col-md-6">
                            <div class="form-group">
                                        <label for="medtype">Bill No:</label>
                                        <select class="form-control" name="billno" id="billno" required>
                                            <option value="" >--Select Bill No--</option>
                                            @foreach($bulkdata as $bkd)
                                            <option value="{{$bkd->billno}}">{{$bkd->billno}}</option>
                                            @endforeach
                                        </select>
                                        @error('medtype')
