            ...
            <div class="col-xl-3 flex-column d-flex grid-margin stretch-card">
              <div class="row flex-grow">
                <div class="col-sm-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                          <h4 class="card-title">Today Patient View</h4>
                          <p></p>
                          <h4 class="text-dark font-weight-bold mb-2">{{$tpatient}}</h4>
                ...
                <div class="col-sm-12 stretch-card">
                    <div class="card">
                      <div class="card-body">
                          ...
                          <p></p>
                          <h4 class="text-dark font-weight-bold mb-2"> ₹ {{$tsale}}</h4>
             ...
             <div class="col-xl-9 d-flex grid-margin stretch-card">
                <div class="card">
                 <!-- <div class="card-body">
                      <h4 class="card-title">Income in this year month wise</h4>
                      <div class="row">
                        <div class="col-lg-5">
                          <p></p>
                        </div>
